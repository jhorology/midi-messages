...
function isSystemCommonMessage(byte) {
    return byte >= 0xf0 && byte <= 0xf7;
}
exports.isSystemCommonMessage = isSystemCommonMessage;
function isSystemRealTimeMessage(byte) {
    return byte >= 0xf7 && byte <= 0xff;
}
exports.isSystemRealTimeMessage = isSystemRealTimeMessage;
